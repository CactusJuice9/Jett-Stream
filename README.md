...
| 3M VHB double sided tape (or other strong adhesive) $\color{#F527E0 }{(*Optional)}$             |                                                                                                |
...
| Mini MP1584EN DC-DC Buck Converter $\color{#F527E0 }{(*Optional)}$ (x1)<br><br>(22mm x 17mm)                         | https://www.amazon.com/MP1584EN-DC-DC-Converter-Adjustable-Module/dp/B01MQGMOKI                |
...
<img width="493" height="310" alt="Image" src="https://github.com/user-attachments/assets/9953acd5-8fa9-41a8-9bb2-354a9b118efc" />
...
\[
\begin{aligned}
\color{#F527E0}{*The\ buck\ converter\ is\ optional\ if\ you\ have\ your\ PD\ trigger\ set\ to\ supply\ 5V.\ You\ can\ wire\ straight\ from\ the\ PD\ trigger;}\\
\color{#F527E0}{for\ example,\ on\ the\ trigger\ I\ use,\ by\ leaving\ all\ pins\ (9V,\ 12V,\ 15V,\ 20V)\ unbridged.\ Even\ though\ it\ is\ unneeded\ for\ the\ Jett,\ it\ can\ be\ handy\ for\ powering\ other\ vibrators\ that\ require\ more\ voltage,\ so\ it\ is\ a\ good\ option\ to\ have.}\\
\color{#F527E0}{If\ you\ decide\ that\ you\ are\ not\ interested\ in\ the\ buck\ converter,\ just\ wire\ straight\ through\ it\ in\ the\ build\ diagram.}
\end{aligned}
\]
...
6. Wire the 2 extra H-Bridge wires from the buck $\color{#F527E0}{*(or\ PD\ trigger\ (5V\ configuration)\ if\ not\ using\ a\ buck)}$ to your H-Bridge. Also attach 2 female dupont cables to IN2 & IN4 (assuming using the same polarity/wire diagram I did) and wire a red & black wire pair to the motor-A and motor-B output. This image is a mess so be sure to consult the wire diagram.
