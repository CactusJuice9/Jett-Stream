...
$\color{#F527E0}{You\ can\ wire\ straight\ from\ the\ PD\ trigger;}$  
$\color{#F527E0}{for\ example,\ on\ the\ trigger\ I\ use,\ by\ leaving\ all\ pins\ (9V,\ 12V,\ 15V,\ 20V)\ unbridged.}$  
$\color{#F527E0}{Even\ though\ it\ is\ unneeded\ for\ the\ Jett,\ it\ can\ be\ handy\ for\ powering\ other\ vibrators\ that\ require\ more\ voltage,\ so\ it\ is\ a\ good\ option\ to\ have.}$  
