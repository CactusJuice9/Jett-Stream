...
<img width="1065" height="672" alt="Image" src="https://github.com/user-attachments/assets/61d70d15-3eb1-4418-9aa5-d39565997794" />
...
<img width="378" height="435" alt="Image" src="https://github.com/user-attachments/assets/929c5729-ed07-4d64-a940-e0d0224addd5" />
...
<img width="290" height="511" alt="Image" src="https://github.com/user-attachments/assets/72fd6164-895e-4553-bffe-e35edfc9c486" />

<img width="204" height="512" alt="Image" src="https://github.com/user-attachments/assets/e92c6011-7c7c-4297-833c-aeedba66ffc8" />
...
<img width="724" height="361" alt="Image" src="https://github.com/user-attachments/assets/e00ce80e-c05d-406c-a828-f04fdf9257f2" />
...
<img width="1374" height="911" alt="Image" src="https://github.com/user-attachments/assets/0e7f21cf-08ba-47bf-b27e-39d1fb5d4c82" />
...
<img width="766" height="403" alt="Image" src="https://github.com/user-attachments/assets/60371b59-bcb1-4616-91dc-d0781429a1b4" />
...
<img width="629" height="666" alt="Image" src="https://github.com/user-attachments/assets/a8ccdd99-d27c-4c4d-b226-9a090e5d0544" />
...
<img width="756" height="913" alt="Image" src="https://github.com/user-attachments/assets/47bf9772-f1eb-4233-8527-ce644e43f11e" />
...
<img width="602" height="501" alt="Image" src="https://github.com/user-attachments/assets/b3530051-bfc1-4281-bc23-e3f9ff369b1a" />

10. Attach your power dupont wire pair to GND and VIN. Then connect your H-bridge IN2 & IN4 to GPIO pin 18 & 19

<img width="1429" height="1014" alt="Image" src="https://github.com/user-attachments/assets/75f09030-19d5-4bf4-a6d3-af89e8816f19" />
...
Flash the firmware onto the esp32 using the bottom usb c. The bottom usb c powers just the ESP32; use this one to upload firmware and connect the device via serial. The top device will power the motors and the ESP32 however doesn't have data pins connected to the ESP32. Once you have Khrull’s firmware this isn’t an issue as you can access the esp32 without it being connected to the computer.Follow the install guide and set the device type to a T-Vibe. V0 (Vib 1) and V1 (Vib 2) should already be set as 18 & 19 in the T-Vibe device profile; if not set them.
 ...
 <img width="618" height="403" alt="Image" src="https://github.com/user-attachments/assets/c22ace12-b133-4404-817a-58a932060eba" />
