...
This really is just a Buck converter and DC motor controller stuffed into a pretty box; Other than that it's the exact same as Tempest's T-Vibe. Thus, you can attach whatever Vibration Toy you want to it. You can remove the 2.5mm jacks all together if you want to use a different vibe bullet. You can make it into a Pogo pin connector, another random Molex standard connector, or even just direct wire a different device right to the motor controller. All you have to do is adjust your voltage to whatever your new you needs and ensure the H-Bridge stepper you choose isnt going to current limit it. Also remeber to drive the control box in the same polarity to whatever deivce you are modding. This shouldnt matter as most DC motors can be driven forward and in reverse but its not worth finding out by frying your new toy. H-Bridge input IN1 & IN3 drive motors forward and IN2 & IN4 drive in reverse.
